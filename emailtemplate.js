...
const getEmailTemplate = (name) =>{
    ...
    <head>
        ...
        <link href="https://fonts.googleapis.com/css2?family=Press+Start+2P&family=Oxygen:wght@400;700&display=swap" rel="stylesheet">
                    ...
                    <table width="640" border="0" cellspacing="0" cellpadding="0" style="background-color: #ffffff; font-family: Arial, sans-serif; border-collapse: collapse; text-align: center;">
                        ...
                        <tr>
                            <td style="padding: 40px 80px; background-color: #003407; color: #FFFFFF; font-size: 18px;">
                                ...
                                <p style="margin: 20px 0; color: #41FD5B;">What is the default port number for HTTP?</p>
                                <table width="100%" border="0" cellspacing="0" cellpadding="10">
                                    <tr>
                                        <td style="color: #41FD5B;">
                                            <div style="border: #41FD5B solid 4px; border-radius: 4px;background-color: #007410; padding: 4px 0px"> 80</div>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td style="color: #41FD5B;">
                        ...
                        <tr>
                            <td style="padding: 10px; text-align: center; font-size: 16px; background-color: #003407; color: #FFF;">
                                ...
                                <details style="font-family: 'Oxygen', Arial, sans-serif; padding-bottom: 40px;">
                                    ...
                                    <p style="margin: 10px 0 0; color: #FFF;">The correct answer is <span style="color: #41FD5B;"><strong> 80</strong></span>.</p>
                                </details>
